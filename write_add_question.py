...
# 1. Update Constants for Middle School, High School, KPSS, ÖABT
...
# 2. Add StudentAddQuestion.jsx
add_question_jsx = """import React, { useState } from 'react';
...
"""
write_file('v2-client/src/pages/StudentAddQuestion.jsx', add_question_jsx)
print("Constants and AddQuestion written.")
