...
# 1. Update package.json to include recharts, jspdf, html2canvas
with open('v2-client/package.json', 'r', encoding='utf-8') as f:
    client_pkg = json.load(f)

client_pkg['dependencies']['recharts'] = '^2.12.5'
client_pkg['dependencies']['jspdf'] = '^2.5.1'
client_pkg['dependencies']['html2canvas'] = '^1.4.1'

write_file('v2-client/package.json', json.dumps(client_pkg, indent=2))

# 2. Update Supabase Schema to include subscription plan
schema_append = """
...
analytics_jsx = """import React from 'react';
...
"""
write_file('v2-client/src/pages/StudentAnalytics.jsx', analytics_jsx)

print("Packages updated, schema modified, analytics added.")
